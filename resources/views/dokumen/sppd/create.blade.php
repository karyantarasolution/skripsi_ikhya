<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Isi data perjalanan dinas dan rincian biaya.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-100">
                <form action="{{ route('dokumen.sppd.store') }}" method="POST" class="p-6 sm:p-8" x-data="biayaForm()">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_berangkat" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Tanggal Kembali <span class="text-red-500">*</span></label>
                            <input type="date" name="tanggal_kembali" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900">
                        </div>
                        <div>
                    ...
                    <div class="mt-8">
                                ...
                                <tbody id="biaya-body">
                                    <template x-for="(row, index) in rows" :key="index">
                                        <tr class="border-t border-gray-100">
                                            <td class="px-4 py-2"><input type="text" x-model="row.uraian" :name="'biaya_uraian[' + index + ']'" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 text-xs" placeholder="cth: Tiket pesawat, Hotel, Uang harian"></td>
                                            ...
                                            <td class="px-4 py-2"><input type="text" x-model="row.satuan" :name="'biaya_satuan[' + index + ']'" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 text-xs" placeholder="cth: malam, orang, unit"></td>
                        ...
                        <p class="text-xs text-gray-400 mt-2">Kosongkan baris jika tidak ada rincian biaya.</p>
                    </div>
    ...
    <script>
        function biayaForm() {
            return {
                rows: [{ uraian: '', volume: 1, satuan: '', harga: '' }],
                addRow() {
